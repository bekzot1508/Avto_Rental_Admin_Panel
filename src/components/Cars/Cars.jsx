            ...
            <form id="myCarForm" onSubmit={postCar}>
               <div className="flex flex-col gap-5">
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <Switch  onChange={(e) => setPostCarModels({...postCarModels, inclusive:e.target.value})}/>
                  </div>
